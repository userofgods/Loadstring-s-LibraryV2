...
function Library:MakeWindows(GuiName)
...
a
		...
		TabButton.MouseButton1Click:Connect(function(checking, found)
	...
	function BCore:AddButton(tab, buttonText, callback)
